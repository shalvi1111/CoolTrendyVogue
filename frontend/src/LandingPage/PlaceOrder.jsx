...
function PlaceOrder() {
    ...
    return ( 
        <div className="container w-100" style={{backgroundColor:"#7E99A3" }}>
        <div className="row " >
          <form onSubmit={handleSubmitOrder}>
            <div className="col-5 text-center p-5 m-5">
              <h1 className='fs-4'><b>Your Address, Our Priority – Smooth & Swift Delivery!</b></h1>

              <div class="mb-3 mt-5" style={{display:"flex"}}>
                <label htmlFor="name" class="form-label me-4" style={{alignSelf:"center"}}><b> NAME:</b> </label>
                <input type="text" class="form-control" name='name' value={nAME} onChange={(e)=> setNAME(e.target.value)} style={{height:"40px" ,width:"380px"}}/>
                </div>

                <div class="mb-3 mt-3" style={{display:"flex"}}>
                <label htmlFor="email" class="form-label me-4" style={{alignSelf:"center"}}><b> EMAIL:</b> </label>
                <input type="email" class="form-control" name='email' value={eMAIL} onChange={(e)=> setEMAIL(e.target.value)}style={{height:"40px" ,width:"380px"}}/>
                </div>

                <div class="mb-3 mt-3" style={{display:"flex"}}>
                <label htmlFor="address" class="form-label me-4" style={{alignSelf:"center"}}><b> ADDRESS:</b> </label>
                <input type="text" class="form-control" name='address'value={address} onChange={(e)=> setAddress(e.target.value)} style={{height:"40px" ,width:"380px"}}/>
                </div>
                ...
                <div class="mb-3 mt-3" style={{display:"flex"}}>
                <label htmlFor="phone" class="form-label me-4" style={{alignSelf:"center"}}><b>PHONE NUMBER:</b> </label>
                <input type="Number" class="form-control" name='phone' value={phone} onChange={(e)=> setPhone(e.target.value)} style={{height:"40px" ,width:"380px"}}/>
                </div>
            </div>

            <div className="col-5 m-5 p-5 text-center">
                <div className="row">
              <h1 className='fs-4' ><b>Fashion at the Right Price!</b></h1>
                  ...
                  <div className="row">
                    <div className="col-4" style={{display:"flex"}}>
                       ...
                       <div class="form-check">
                         <input class="form-check-input" type="radio" name="paymentMethod"  value="cod"  checked={paymentMode === 'COD'}
                           onChange={(e) => setPaymentMode(e.target.value)} />
                           <label class="form-check-label" for="cod">
                           <img src='../font-awesome/images/cash-on-delivery.png' alt='COD' value={paymentMode} onChange={(e)=>setPaymentMode(e.target.value)} style={{height:"100px" ,width:"100px"}} className='m-2'/>
                           </label>
                        </div>
                        ...
                        <div class="form-check">
                         ...
                         <input class="form-check-input" type="radio"name="paymentMethod" value="stripe" 
                          ...
                          onChange={(e) => setPaymentMode(e.target.value)}   />
                           <label class="form-check-label" htmlFor="paymentMethod">
                           <img src='../font-awesome/images/stripe.png' value={paymentMode} onChange={(e)=>setPaymentMode(e.target.value)} alt='stripe'style={{height:"100px"  ,width:"100px"}} className='m-2' />
                           </label>
                        </div>
