...
function Kid() {
   ...
   {products.map((product) => (
    ...
    <h1 className='fs-4 text-center m-5 p-5'> "<span style={{color:"red"}}>Oops!</span> No Kid's category found. <span style={{color:"purple"}}>Maybe they ran off to play?</span>"</h1>
)}
</>
     );
}
